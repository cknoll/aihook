...
- `aihook --vars` — list all non-dunder names (i.e. names not starting with `__`) in the session namespace with their types, sorted alphabetically. Useful as a first probe to discover what's in scope.
